...
class marketFrontend {
  ...
  public function accountAction() {
    ...
    switch ($action) :
      ...
      case self::action_login :
        ...
        // Login ist noch nicht erfolgreich
   ...
   *
   * @param
   *          action - aktives Navigationselement
   * @param
   *          content - Inhalt
   *
   * @return ECHO RESULT
  ...
  public function accountAdvertisementAdd() {
    ...
    $form = array(
      ...
      'id' => array(
        'name' => dbMarketAdvertisement::field_id,
        'value' => $ad_id
      ),
    ...
    $advertisement = array(
      ...
      'status' => array(
        'name' => dbMarketAdvertisement::field_status,
        'value' => array(
          'closed' => array(
            'value' => dbMarketAdvertisement::status_closed,
  ...
  public function marketShowCategory(&$cat_id = -1) {
    ...
    if ($cat_id < 1) {
      ...
      $where = array(
        dbMarketCategories::field_id => $cat_id
      );
      $category = array();
      if (!$dbMarketCats->sqlSelectRecord($where, $category)) {
